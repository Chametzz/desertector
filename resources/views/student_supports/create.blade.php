<x-layouts::app :title="__('Registrar apoyo')">
    <div class="max-w-2xl mx-auto">
        <div class="rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-6">
            <h1 class="text-xl font-bold dark:text-white mb-6">Registrar nuevo apoyo</h1>

            <form method="POST" action="{{ route('student_supports.store') }}">
                @csrf
                @include('student_supports.fields', ['student_support' => null])
